        ...
        <section id="pricing" className="w-full flex flex-col items-center space-y-6 py-12 bg-card rounded-xl p-6 md:p-10 my-8 border border-accent/50 shadow-lg shadow-accent/10">
          ...
          <div className="w-full max-w-sm pt-4">
           ...
           <div className="flex items-center space-x-2 pt-4">
              <span className="text-sm text-red-400">⚠️ ATENÇÃO: ESSA OFERTA EXCLUSIVA ACABA EM</span>
              <div className="bg-red-500/20 text-red-400 text-sm font-bold px-2 py-1 rounded">
                <CountdownTimer />
              </div>
           </div>
        </section>
